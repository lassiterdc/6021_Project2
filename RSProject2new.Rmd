...
no27.trend.seasonal2 <- lm(NO2.7.ts ~ time.no2 + sin(2*pi*time.no2/7) + cos(2*pi*time.no2/7) + sin(2*pi*time.no2/365) + cos(2*pi*time.no2/365))
...
ggplot(dailyAQ.7, aes(x=Group.1,y=NO2.GT.)) + geom_line() + 
  geom_line(aes(x=Group.1,y=no27.trend.seasonal2$fitted.values),color="red") 
...
plot(ts(next.wk$no27),type='o',ylim=c(150,300))
